  ...
  public: {
    ...
    Tables: {
      daily_claims: {
        ...
        Update: Partial<Database["public"]["Tables"]["daily_claims"]["Row"]>;
      };
      economy_logs: {
        Row: {
          amount: number;
        ...
        Update: Partial<Database["public"]["Tables"]["economy_logs"]["Row"]>;
      };
      raid_cells: {
        Row: {
          cell_index: number;
        ...
        Update: Partial<Database["public"]["Tables"]["raid_cells"]["Row"]>;
      };
      raids: {
        Row: {
          ended_at: string | null;
        ...
        Update: Partial<Database["public"]["Tables"]["raids"]["Row"]>;
      };
      referrals: {
        Row: {
          created_at: string;
